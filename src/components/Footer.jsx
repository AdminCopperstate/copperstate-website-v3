...
export default function Footer() {
  return (
    <footer className="bg-ink border-t border-ink-line py-8">
      <div className="max-w-7xl mx-auto px-5 md:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
        <img src={logo} alt="Copperstate Machine & Industrial Service" className="h-7 w-auto opacity-80" />
        <p className="text-graphite text-[12px] normal-case">
