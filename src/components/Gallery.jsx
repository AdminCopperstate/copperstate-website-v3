...
const PHOTOS = [
  ...
  { src: '/gallery/photo-7.jpg', caption: 'Structural Steel Recoat', category: 'Fabrication' },
  { src: '/gallery/photo-8.jpg', caption: 'Completed Installation', category: 'Field Crew' },
  { src: '/gallery/photo-9.jpg', caption: 'Drive Inspection & Assessment', category: 'Clarifiers' },
